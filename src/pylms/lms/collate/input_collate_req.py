...
def input_collate_req() -> CollateReq:
    ...
    :return: (CollateReq) - A tuple of the pass mark and the two ratios.
    :rtype: CollateReq
    """
    # 1. prompt the user to enter a pass mark
    pass_mark: int = input_marks_req("Enter the Pass Mark [1 - 100]: ")
    ...
    assessment_ratio: float = input_ratio_req("Enter the Assessment Ratio [0 - 1]: ")

    # 4. prompt the user to enter the project ratio
    project_ratio: float = input_ratio_req("Enter the Project Ratio [0 - 1]: ")
    ...
    return CollateReq(
        pass_mark, assessment_ratio, project_ratio
    )
