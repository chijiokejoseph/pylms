...
from ._clean_intl import clean_intl


def clean_intl_irregular(entry: str) -> str:
    """
    ...
    return clean_intl(entry)


def clean_intl_comp_irregular(entry: str, delim: str) -> str:
    ...
    if delim != SPACE_DELIM:
        ...
        for each_entry in entries:
            output += clean_intl_irregular(each_entry) + SPACE_DELIM
