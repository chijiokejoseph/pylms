...
def clean_composite(entry: str, delim: str) -> str:
    """
    ...
    for each_entry in entries:
        ...
        output += clean11(each_entry) + SPACE_DELIM
    return output.strip()


def clean_space_sep(entry: str) -> str:
    """
    ...
    :return: formatted local phone number
    """
    return clean_composite(entry, SPACE_DELIM)


def clean_comma_sep(entry: str) -> str:
    """
    ...
    :return: formatted local phone number
    """
    return clean_composite(entry, COMMA_DELIM.strip())


def clean_semi_sep(entry: str) -> str:
    """
    ...
    :return: formatted local phone number
    """
    return clean_composite(entry, SEMI_DELIM.strip())
