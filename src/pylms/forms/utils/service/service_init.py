...
from pylms.constants import CREDENTIALS_PATH
from google.oauth2.service_account import Credentials as ServiceCredentials
from apiclient import discovery


def _load_creds() -> ServiceCredentials:
    creds = ServiceCredentials.from_service_account_file(str(CREDENTIALS_PATH))
    return creds


def init_service(
    api: Literal["drive", "forms"], version: Literal["v3", "v1"]
) -> Callable:
