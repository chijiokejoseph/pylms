...
from pylms.forms.utils.service import Form
from pylms.utils import DataStore, paths


def init_class_form(ds: DataStore, form_dates: list[str]) -> None:
    ...
    for date in form_dates:
        ...
        data_url: ClassFormInfo = ClassFormInfo(
            date=date,
        ...
        with metadata_path.open("w", encoding="utf-8") as file:
            json.dump(data_url.model_dump(), cast(TextIOWrapper, file), indent=2)
