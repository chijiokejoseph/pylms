...
def input_class_date(history: History) -> Result[list[str]]:
    """Get class dates available for attendance marking.
    
    Args:
        history (History): History object containing class information.
        
    Returns:
        Result[list[str]]: Success with list of available dates or error.
    """
